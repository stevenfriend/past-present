...
const jpn = ['洗濯をした', 'ピクニックをした', '店に行った', 'ボードゲームをした', '調理された夕食', '映画を見た', '小説を読んだ', 'ブレスレットを作った', '英国語を勉強した', '車を洗った', 'テストを受けた', 'プレゼントをもらった', '凧を飛ばした', '犬を散歩させた', '音楽を聞いた', '私の机を掃除した', 'バイオリンを練習した', 'レースに勝った', '砂の城を建てた', '祖父母を訪ねた', ]
const images = [];
const phrases = [];
